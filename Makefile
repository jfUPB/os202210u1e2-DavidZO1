...
$(D_EXAMPLE)/main.out: $(D_EXAMPLE)/main.c $(D_OBS)/observer.o $(D_OBS)/subject.o $(D_MODELS)/leon.o $(D_MODELS)/zebra.o
	@$(CC) $(CFLAGS) -o $@ $^

$(D_MODELS)/leon.o: $(D_MODELS)/leon.c $(D_OBS)/observer.o $(D_OBS)/subject.o
	@$(CC) $(CFLAGS) $^ -c -o $@

$(D_MODELS)/zebra.o: $(D_MODELS)/zebra.c $(D_OBS)/observer.o
	@$(CC) $(CFLAGS) $^ -c -o $@
